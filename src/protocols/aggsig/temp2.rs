...
impl State {
    ...
    pub fn sign_2(&mut self, message: &[u8], pks:&Vec<GE>, msg_vec: Vec<Vec<GE>>, party_index:usize) ->BigInt {
...
mod tests {
    ...
    fn test_multiparty_signing_for_two_parties() {
        ...
        let R1 = party_1.sign_2(&message, &pks,party1_first_msg,0);
        let R2 = party_1.sign_2(&message, &pks,party2_first_msg,0);
